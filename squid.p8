...
// objectpools
function _init()
 mapdata = "ナ「a⁘g a⁘f b⁘ウ」a◀a⁙g◀a⁙d■b◀b⁙o#f⁘b#f⁘g#k⁙o⁘b⁙✽⁘c⁙f◀b⁙b■a)a⁙c◀a:a■a⁙b■a;a◀b■a⁙n#█⁙か◀b⁙d■a⁙b‖a⁘a」a⁙d◀b⁙a*a⁙a「a」a⁙d■d⁙b#█⁙か◀b⁙a■a⁙g‖a。a⁙c◀b⁙a「a⁘a▶a゜a⁙c■a⁙d■a⁙a#█⁙か◀b⁙f■a⁙b■a⁙d‖a&a⁘a▶a⁙e■a⁙f■a#█⁙か◀a‖a⁘b」a⁙f「a⁘a」a⁙k■a⁙f■a#█⁙か◀a•a、b‖a⁘a」a⁙b「a⁘a▶a「a▶a⁙k■a⁙f■a#█⁙か◀a、a•a「a⁘b▶a⁙b‖a⁘b▶a⁙l■a⁙f■a#█⁙か◀a「a⁘a▶a⁙h■c⁙a「a a⁘a。a⁙f■a⁙d■a⁙a#█⁙か◀b⁙b■a⁙i■b◀b⁙i■d⁙b#█⁙か◀b⁙b■b⁙cAd⁙b■a‖a▶a⁙o#█⁙か◀b)a⁙b■a⁙dAb⁙d■a⁙p#█⁙か◀b⁙b■a⁙a■a⁙cAb⁙c■b⁙p#█⁙か◀b⁙a■b⁙eAa⁙d■a⁙q#█⁙か◀a‖a⁘a」a■b「a⁘e」a■b⁙r#█⁙か◀a「a⁘a▶a⁙b‖a⁘e▶a⁙ク◀b⁙テ◀b⁙テ◀b⁙p▮b⁙a「a⁘a。a⁙a'a⁘b」a⁙g/g⁙ふ◀b⁙e/a.a/a.a/a⁙d▮d⁙a◀a■f◀a⁙g/a@e/a⁙ふ◀b⁙a*a⁙c/a⁙a)a⁙a/a⁙d▮d⁙a◀a■f゜a⁙g/a@e/a⁙ふ◀b⁙a*a⁙c/a⁙c/a⁙d▮d⁙a゜a■f⁙h/a@e/a⁙ふ◀b⁙a*a⁙c/a.a-a.a/a⁙d▮d⁙b■c+a■b゛a⁙g/a@e/a⁙ふ◀b⁙a*a⁙l▮d⁙a゛a■f◀a⁙g/c?a/c⁙ふ◀b⁙a*a⁙l▮d⁙a◀a■f◀a⁙れ◀b⁙d-a⁙b-a⁙b-a⁙c▮d⁙a‖a⁘b。a⁙a'a⁘a▶a⁙れ◀b⁙o▮b⁙イ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙テ◀b⁙あ⁘d⁙き◀a‖a⁘テ▶a"
	hitboxes = {}
	make_player()
	bombpool = {}
	explosions = {}
...
function _draw()
	cls(2)
	decompress(mapdata,mset,128,64)
	map()
	bomb_animation()
	draw_player()
...

...

