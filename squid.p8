...
function add_object(x,y,
	...
	// initial sprite of choice
	obj.sprite = sprite
	
	// init obj duration and hp,
	// init duration to -2 for 
	// objects that don't die w/ time
...
function update_object(obj)
	...
	if obj.hb!=nil and obj.hb.issolid then
		...
		while obj.dx<0 and 0 < #searchmapcols(obj.hb, 0b1, 0+(flr(abs(obj.dx+.5))*sgn(obj.dx)),1, -(obj.hb.right-obj.hb.left),-1) do
			...
			if obj.dx>-1 then
				obj.dx = 0
			// obtain midpoint between object
			// dx lim -> 0, 0 itself, and
			// large negative max each frame
			else
				obj.dx = mid(obj.dx+1,0,-100000)
			// when obj.dx+1>0, 0 becomes
			// the midpoint
			end
		end
		//right collision
...
function update_enemy1(enm1)
	...
	if path != nil then
		enm1.dcv += 1
	 local dcv, dcs = enm1.dcv,enm1.dcs
		if dcv%6 == 0 then
			if dcv == 48 then
				enm1.dcv = 0
				enm1.dx *= 8
...
3030303030303030303030303030303060000000000000f041410000000000603030303030303030303030303030603030306060606060603030303030303060
...
30303030303030303030303030303030100000000000001041000000000000603030303030303030303030303030603030306060606060603030303030303060
...
30303030303030303030303030303030000000000000414100000000000000603030303030303030303030303030603030306060606060603030303030303060
...

...

